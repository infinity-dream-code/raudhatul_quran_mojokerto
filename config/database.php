...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'sso' => [
            'driver' => 'mysql',
            'host' => env('SSO_DB_HOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('SSO_DB_PORT', env('DB_PORT', '3306')),
            'database' => env('SSO_DB_DATABASE', env('DB_DATABASE', 'laravel')),
            'username' => env('SSO_DB_USERNAME', env('DB_USERNAME', 'root')),
            'password' => env('SSO_DB_PASSWORD', env('DB_PASSWORD', '')),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        // Alias koneksi modul cashless (sama DB SIKEU, kompatibel mualimat_cashless).
        'DATA_MYSQL' => [
            'driver' => 'mysql',
            'host' => env('SIKEU_DB_HOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('SIKEU_DB_PORT', env('DB_PORT', '3306')),
